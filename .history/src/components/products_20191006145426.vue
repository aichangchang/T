<template>
	<div class="main">
        ...
        <img v-bind:src="systemData.CentralControlSystem.src"  />
        <img src="src/assets/proImages/System/CentralControlSystem/CentralControlSystem.jpg"  />
			</div>
		</div>
	</div>
</template>
...
<script>
  ...
  import systemData from '../../static/SystemData.json';
	export default {
		components: {
			MenuWrap
    },
